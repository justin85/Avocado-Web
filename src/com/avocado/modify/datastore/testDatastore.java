...
//	private static long FN=0;
    ...
    public testDatastore(Date date,String correct,String acti,String IMEI,String FNS,Text myText) {
    	this.myText=myText;
    	this.acti=acti;
        this.IMEI = IMEI;
...
//        setFN(FN);
    ...
    public testDatastore(Date date,String correct,String acti,String IMEI,String FNS,Text myText,String phone_location,String comment) {
    	this.myText=myText;
    	this.acti=acti;
        this.IMEI = IMEI;
        this.correct=correct;
