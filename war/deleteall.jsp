...
<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
    <title>Activity Recorder::Delete All</title>
  <style type="text/css">
<!--
...
<li><a href=""><em>Sensor Data</em></a></li>
