...
String query = "select from " + Activitystore.class.getName() + " where UID=='"+UID+"'";
List<Activitystore> datastores = (List<Activitystore>) pm1.newQuery(query).execute();
%><p>Total <b><%=datastores.size() %></b> items were deleted.</p><%
pm1.deletePersistentAll(datastores);

response.sendRedirect("http://activity.urremote.com/actihistory.jsp");
%>
